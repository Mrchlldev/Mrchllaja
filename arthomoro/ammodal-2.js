...
:root {
    --am-modal-bg: var(--contentB, #ffffff);
    --am-modal-border: var(--contentL, #e5e7eb);
    --am-modal-primary: var(--linkC, #2563eb);
    --am-modal-text: var(--textC, #172033);
    --am-modal-muted: #64748b;

    --am-modal-radius: 22px;
...
.am-modal {
    ...
    color: var(--am-modal-text);
    background: var(--am-modal-bg);

    border: 1px solid var(--am-modal-border);
    border-radius: var(--am-modal-radius);
...
.am-modal-overlay.am-modal-show .am-modal {
    opacity: 1;
...
.am-modal-bottom .am-modal-handle {
    display: block;
}
...
.am-modal-btn-primary {
    color: #fff;
    background: var(--am-modal-primary);
}
...
`;
    ...
    const AMModal = {
        ...
        renderField(field = {}) {
            ...
            const requiredMark =
                required
                    ? `<span class="am-modal-required">*</span>`
                    : "";
