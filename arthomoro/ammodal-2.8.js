...
`;
    ...
    const AMModal = {
                    ...
                    confirmButton.addEventListener(
                        ...
                        async () => {
                            ...
                            try {
                                ...
                                /*
                                 * false berarti callback
                                 * menangani penutupan sendiri.
                                 */
                ...
                close: (animated = true) => {
                    ...
                    const remove =
                        () => {
                            ...
                            /*
                             * Hanya restore overflow
                             * jika modal ini memang
                             * yang mengunci body.
                             */
        ...
        form(options = {}) {
                ...
                this.open({
                    ...
                    onConfirm:
                        async context => {
                            ...
                            /*
                             * Validasi manual.
                             * novalidate dipasang pada form
                             * agar browser tidak menampilkan
                             * UI bawaan yang tidak konsisten.
                             */
            ...
            /*
             * Tambahan:
             * jika user menekan Enter pada input,
             * submit diarahkan ke tombol Confirm.
             */
